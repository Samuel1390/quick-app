...
import type { ModelHashes } from "../../dashboard/components/ai-assistant/segment-ai/app/constants"
import type { HistoryData } from "../../dashboard/components/ai-assistant/segment-ai/app/hooks/useChatState" // TIPADO ACTUALIZADO
import type {
  GroqMessage,
  GeminiMessage,
  CohereMessage,
} from "../../dashboard/components/ai-assistant/segment-ai/app/types"
import handleFiles from "../../dashboard/components/ai-assistant/segment-ai/app/utils/handleFiles"
import getModelObj from "../../dashboard/components/ai-assistant/segment-ai/app/utils/getModelObj"
...
export async function POST(request: Request) {
  try {
    ...
    const instruccions = await fs.readFile(
      path.join(process.cwd(), "app/api/chat/ModelInstructions.md"),
      "utf-8"
    )
